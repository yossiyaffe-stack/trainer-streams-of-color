...
serve(async (req) => {
  ...
  try {
    ...
    if (syncType === 'all' || syncType === 'subtypes') {
      ...
      const hubSubtypes = await fetchFromHub<HubSubtype[]>('/subtypes');
      ...
      if (hubSubtypes && Array.isArray(hubSubtypes)) {
        ...
        for (const hubSubtype of hubSubtypes) {
          try {
            ...
            const localSubtype = {
              ...
              season: hubSubtype.season?.toLowerCase() || 'winter',
              palette_effect: hubSubtype.palette_effect || null,
              description: hubSubtype.description || null,
              key_colors: hubSubtype.key_colors || [],
              avoid_colors: hubSubtype.avoid_colors || [],
              fabrics_perfect: hubSubtype.fabrics_perfect || [],
              fabrics_good: hubSubtype.fabrics_good || [],
              fabrics_avoid: hubSubtype.fabrics_avoid || [],
              prints: hubSubtype.prints || [],
              silhouettes: hubSubtype.silhouettes || [],
              jewelry_metals: hubSubtype.jewelry_metals || [],
              jewelry_stones: hubSubtype.jewelry_stones || [],
              jewelry_styles: hubSubtype.jewelry_styles || [],
              eras: hubSubtype.eras || [],
              artists: hubSubtype.artists || [],
              designers: hubSubtype.designers || [],
              makeup_lip: hubSubtype.makeup_lip || [],
              makeup_cheek: hubSubtype.makeup_cheek || [],
              makeup_eye: hubSubtype.makeup_eye || [],
              best_for: hubSubtype.best_for || [],
              time_period: hubSubtype.time_period || null,
              is_active: true,
            };
        ...
        results.subtypes = { synced: 0, errors: ['Failed to fetch subtypes from Hub'] };
      }
    }
