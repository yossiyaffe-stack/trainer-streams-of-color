...
const METHODOLOGY_SUBTYPES: SubtypeData[] = [
  ...
  },
  {
    ...
    season: "summer",
    time_period: "late",
    description: "A muted, romantic palette with cowgirl and Grecian influences. Deep roses and sangria with teal and aqua accents.",
    palette_effect: "Gibson Girl, Cowgirl, Grecian",
    key_colors: ["Cream", "Rose", "Deep Rose", "Mauve", "Sangria", "Burgundy", "Deep Purple", "Chocolate", "Teal", "Aqua", "Silver Blue"],
    avoid_colors: [],
    fabrics_perfect: ["Jersey", "Angora", "Velvet", "Chenille", "Chiffon", "Fine Cotton", "Organza"],
    fabrics_good: ["Fine Corduroy", "Mohair", "Colored Denim"],
    fabrics_avoid: [],
    prints: ["Leopard Print chiffon", "Graphics and Florals mixed"],
    silhouettes: ["Cowboy Boots", "Oval Toe", "Espadrilles", "Mermaid style", "A line", "Fine pleats"],
    jewelry_metals: ["Antique Gold", "Silver"],
    jewelry_stones: ["Aquamarine", "Labradorite", "Turquoise", "Opals", "Rose Quartz", "Pink Pearls"],
    jewelry_styles: ["Small Charms", "Hearts and Flowers", "Enameled Flowers"],
    eras: ["Gibson Girl", "Edwardian Era", "English 1800's", "American Pioneer"],
    artists: [],
    designers: [],
    makeup_lip: ["Mauve", "Sangria"],
    makeup_cheek: ["Rose", "Mauve"],
    makeup_eye: ["Green and gold eyeliner"],
    best_for: ["Cowgirl events", "Romantic occasions"],
  },
  {
    slug: "english-summer",
    name: "English Summer",
    season: "summer",
    time_period: "late",
    description: "Late English summer palette with sunlight shining through the woods. Mauve roses and teal-emerald accents.",
    palette_effect: "Sunlight shining through the woods",
    key_colors: ["Pink Mauve", "Mauve-Rose", "Rose", "Dark Rose", "Wine", "Burgundy", "Blue Black", "Prussian Blue", "Slate Blue", "Teal", "Blue Green", "Emerald"],
    avoid_colors: [],
    fabrics_perfect: ["Embroidered Chiffon", "Applique", "Jacquard", "Tapestry", "Fine Lace"],
    fabrics_good: ["Fine tweed", "Fine Wool knit", "Linen Cotton", "Cotton Organza", "Chenille", "Stretch velvet"],
    fabrics_avoid: [],
    prints: ["Pearls", "Seashells", "Roses", "Lilies", "Lilacs", "Tulips", "Lavender", "Birds and Flowering trees", "Watercolor Prints"],
    silhouettes: ["Oval neckline", "Sweetheart neckline", "Cowl neck", "Bell Sleeve", "Butterfly sleeve"],
    jewelry_metals: ["Rose Gold", "Gold", "Silver"],
    jewelry_stones: ["Green Glass", "Labradorite", "Pearls", "Topaz", "Green Opal", "Agate", "Aquamarine"],
    jewelry_styles: ["Delicate colored beads", "Dangling pearls", "Clusters of stones", "Chandelier earrings"],
    eras: ["English 1800's", "Art Deco", "French 1700's"],
    artists: ["Monet", "Manet"],
    designers: [],
    makeup_lip: ["Burgundy"],
    makeup_cheek: ["Rose tones"],
    makeup_eye: ["Green eyeliner", "Gold eyeshadow"],
    best_for: ["English garden events", "Late summer occasions"],
  },
  {
    slug: "rose-gold-summer",
    name: "Rose Gold Summer",
    season: "summer",
    time_period: "mid",
    description: "A warm summer palette centered on rose gold with English rose and Renaissance influences.",
    palette_effect: "English Rose Garden",
    key_colors: ["Rose Gold", "Rose", "Antique Rose", "Peach-Rose", "Cream", "Ivory", "Coral Rose", "Velvet Rose", "Taupe", "Mushroom", "Navy Blue", "Teal", "Emerald"],
    avoid_colors: [],
    fabrics_perfect: ["Fine Velvet", "Crushed Velvet", "Velour", "Jersey", "Fine Tweed", "Tulle", "Chiffon", "Lace"],
    fabrics_good: ["Crocheted Lace", "Gauze Cotton", "Silk", "Denim", "Fine Corduroy", "Chambray"],
    fabrics_avoid: [],
    prints: ["Hearts", "Fleur De Lis", "Ribbons", "Toile", "Peonies", "Tulips", "Hollyhocks", "Dogwood", "Hydrangeas", "Paisley", "Polka Dots"],
    silhouettes: ["A line Skirt", "A line Dress", "Bell Sleeve", "Puff Sleeve", "Square Neckline", "Sweetheart Neckline"],
    jewelry_metals: ["Rose Gold", "Woven Gold", "Silver"],
    jewelry_stones: ["White Coral", "Pearls", "Pink Coral", "Sea Glass", "Aventurine", "Topaz", "Blue Topaz", "Opals"],
    jewelry_styles: ["Hearts", "Lockets", "Ribbons", "Delicate chains", "Layered rings"],
    eras: ["Gibson Girl", "French 1700's", "England 1800's", "Ancient Greece", "Edwardian"],
    artists: ["Sargent", "Manet"],
    designers: ["BlueMarine", "Chloe", "Ulla Johnson", "Stella McCartney"],
    makeup_lip: ["Coral", "Rose"],
    makeup_cheek: ["Rose", "Cream"],
    makeup_eye: ["Emerald", "Teal"],
    best_for: ["Rose gold events", "Renaissance occasions"],
  },
  ...
  {
    slug: "burnished-autumn",
    name: "Burnished Autumn",
    season: "autumn",
    time_period: "mid",
    description: "Deep, polished autumn tones with antique gold and pewter influences. Rich burgundy and emerald with warm neutrals.",
    palette_effect: "Antique Tapestry",
    key_colors: ["Burgundy", "Wine", "Terra Cotta", "Olive", "Forest Green", "Emerald", "Antique Gold", "Pewter", "Charcoal"],
    avoid_colors: [],
    fabrics_perfect: ["Brocade", "Tapestry", "Velvet", "Silk Shantung", "Leather"],
    fabrics_good: ["Tweed", "Cashmere", "Fine Wool", "Suede", "Lace"],
    fabrics_avoid: [],
    prints: ["Paisley", "Brocade patterns", "Tapestry designs", "Herringbone", "Animal prints"],
    silhouettes: ["Structured jackets", "Column dresses", "Tailored pants"],
    jewelry_metals: ["Antique Gold", "Pewter", "Bronze", "Copper"],
    jewelry_stones: ["Emeralds", "Rubies", "Topaz", "Amber", "Garnet"],
    jewelry_styles: ["Links", "Chains", "Medieval inspired", "Coins", "Filigree"],
    eras: ["Medieval", "Renaissance", "Spanish Golden Age"],
    artists: ["Velázquez", "Rembrandt"],
    designers: ["Etro", "Oscar de la Renta"],
    makeup_lip: ["Burgundy", "Wine"],
    makeup_cheek: ["Bronze", "Warm rose"],
    makeup_eye: ["Gold", "Bronze", "Emerald"],
    best_for: ["Medieval events", "Renaissance occasions"],
  },
  {
    slug: "cloisonne-autumn",
    name: "Cloisonné Autumn",
    season: "autumn",
    time_period: "mid",
    description: "Jewel-toned autumn palette inspired by cloisonné enamelwork. Rich teals, corals and golds with intricate pattern influences.",
    palette_effect: "Cloisonné Art",
    key_colors: ["Teal", "Coral", "Terra Cotta", "Gold", "Navy", "Emerald", "Burgundy", "Cream", "Black"],
    avoid_colors: [],
    fabrics_perfect: ["Silk", "Satin", "Brocade", "Jacquard", "Velvet"],
    fabrics_good: ["Embroidered fabrics", "Fine wool", "Cashmere"],
    fabrics_avoid: [],
    prints: ["Chinese motifs", "Persian designs", "Florals", "Birds", "Geometric borders"],
    silhouettes: ["Mandarin collar", "Kimono style", "Column dress", "Wrap tops"],
    jewelry_metals: ["Gold", "Antique Gold", "Copper"],
    jewelry_stones: ["Jade", "Coral", "Turquoise", "Lapis", "Carnelian"],
    jewelry_styles: ["Cloisonné", "Enamel", "Asian-inspired", "Intricate patterns"],
    eras: ["Chinese Dynasty", "Persian", "Art Nouveau"],
    artists: ["Klimt"],
    designers: ["Etro", "Dries Van Noten"],
    makeup_lip: ["Coral", "Red-orange"],
    makeup_cheek: ["Coral", "Peach"],
    makeup_eye: ["Teal", "Gold", "Bronze"],
    best_for: ["Cloisonné-inspired events", "Asian occasions"],
  },
  {
    slug: "grecian-autumn",
    name: "Grecian Autumn",
    season: "autumn",
    time_period: "early",
    description: "Mediterranean-inspired autumn palette with olive, terracotta and golden tones. Classical Grecian influences with draped silhouettes.",
    palette_effect: "Grecian Temple",
    key_colors: ["Olive", "Terra Cotta", "Gold", "Cream", "Ivory", "Sage", "Burgundy", "Navy", "Charcoal"],
    avoid_colors: [],
    fabrics_perfect: ["Linen", "Silk", "Jersey", "Chiffon", "Fine Cotton"],
    fabrics_good: ["Cashmere", "Fine Wool", "Suede"],
    fabrics_avoid: [],
    prints: ["Greek key", "Meander", "Olive branches", "Classical motifs", "Subtle stripes"],
    silhouettes: ["Draped dresses", "Column silhouette", "Toga-inspired", "Grecian necklines"],
    jewelry_metals: ["Gold", "Antique Gold"],
    jewelry_stones: ["Olive jade", "Amber", "Pearls", "Coral"],
    jewelry_styles: ["Greek key patterns", "Coin jewelry", "Laurel wreaths", "Classical motifs"],
    eras: ["Ancient Greece", "Classical", "Mediterranean"],
    artists: ["Botticelli"],
    designers: ["Donna Karan", "Max Mara"],
    makeup_lip: ["Terra cotta", "Nude"],
    makeup_cheek: ["Warm bronze", "Peach"],
    makeup_eye: ["Gold", "Bronze", "Olive"],
    best_for: ["Grecian events", "Classical occasions"],
  },
  {
    slug: "multi-colored-autumn",
    name: "Multi-Colored Autumn",
    season: "autumn",
    time_period: "mid",
    description: "A rich, multicolored tapestry palette. Queen Esther influences with coral, emerald and cobalt jewel tones.",
    palette_effect: "Queen Esther Palette",
    key_colors: ["Putty", "Ecru", "Oyster-Shell", "Soft Terra Cotta", "Prussian Blue", "Cobalt Blue", "Olive Green", "Coral Orange", "Rust Red", "Gold", "Emerald", "Deep Purple"],
    avoid_colors: [],
    fabrics_perfect: ["Chiffon", "Black/Brown lace", "Linen", "Satin", "Cashmere", "Pashmina", "Sari cloth"],
    fabrics_good: ["Suede", "Velvet", "Embossed leather"],
    fabrics_avoid: [],
    prints: ["Paisley", "Geometric Shapes", "Mosaic patterns", "Missoni Stripe"],
    silhouettes: ["Asymmetrical hemlines", "Wrap dresses", "V neckline", "Cape like wraps", "Mandarin Collar"],
    jewelry_metals: ["Antique Gold", "Copper", "Bronze"],
    jewelry_stones: ["Jasper", "Labradorite", "Coral", "Turquoise", "Topaz", "Amber", "Green Onyx", "Ivory"],
    jewelry_styles: ["Braided chains", "Links", "Woven Gold", "Ropes and Tassels", "Chandelier earrings", "Cloisonne"],
    eras: ["Persian", "Spanish Renaissance"],
    artists: ["El Greco", "Corot", "Modigliani"],
    designers: ["Cavalli", "Missoni", "Brunello Cuccinelli"],
    makeup_lip: ["Orange", "Rust Red", "Nude"],
    makeup_cheek: ["Neutral", "Terracotta"],
    makeup_eye: ["Kohl", "Smokey", "Gold"],
    best_for: ["Multi-cultural events", "Queen Esther occasions"],
  },
  {
    slug: "persian-autumn",
    name: "Persian Autumn",
    season: "autumn",
    time_period: "mid",
    description: "Rich Persian-inspired palette with coral, jade and gold. Moroccan tile and Japanese garden influences.",
    palette_effect: "Spanish Desert",
    key_colors: ["Terra Cotta", "Soft Peach", "Coral", "Red Coral", "Orange", "Rust", "Wine Red", "Jade", "Emerald", "Prussian Blue", "Midnight Blue", "Olive"],
    avoid_colors: [],
    fabrics_perfect: ["Metallic Chiffon", "Lace", "Wool Knit", "Silk Shantung", "Denim", "Leather", "Suede"],
    fabrics_good: ["Sari Fabric", "Tweed"],
    fabrics_avoid: [],
    prints: ["Birds, Tigers, Elephants and Leopards", "Paisley", "Geometric Shapes", "Mosaic patterns", "Kimono Prints", "Peacock feathers"],
    silhouettes: ["Kaftan", "Sari inspired", "Kimono", "Column dress"],
    jewelry_metals: ["Gold", "Antique gold", "Copper", "Pewter"],
    jewelry_stones: ["Polished Jade", "Amber", "Pearls", "Ivory"],
    jewelry_styles: ["Birds, Branches, Leaves and Feathers", "Hammered gold", "Mosaic and Enamel designs"],
    eras: ["Persian", "Moroccan", "Japanese"],
    artists: ["Corot", "Modigliani", "Gauguin"],
    designers: ["Etro", "Dries Van Noten", "Cavalli"],
    makeup_lip: ["Coral", "Rust"],
    makeup_cheek: ["Terracotta", "Peach"],
    makeup_eye: ["Kohl", "Bronze", "Teal"],
    best_for: ["Persian events", "Moroccan occasions"],
  },
  {
    ...
    season: "autumn",
    time_period: "mid",
    description: "Spanish and Mediterranean inspired palette with tapestry and mosaic influences. Coral and emerald with antique metals.",
